"""Immutable contracts for the Executive Timeline."""
...
class TimelineEventKind(str, Enum):
    ...
    DIRECTOR_REGISTERED = "director_registered"
    DIRECTOR_UNREGISTERED = "director_unregistered"
    DIRECTOR_READINESS_CHANGED = "director_readiness_changed"
