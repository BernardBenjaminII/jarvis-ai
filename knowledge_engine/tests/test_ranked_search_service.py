...
class RankedSearchServiceTests(unittest.TestCase):
    ...
    @patch(
        "knowledge_engine.search.service.RankingService"
    )
    @patch(
        "knowledge_engine.search.service.RetrievalService"
    )
    def test_search_retrieves_broad_candidate_pool(
        ...
        retrieval = retrieval_class.return_value
    ...
    def test_retrieval_tuple_is_normalized_for_ranking(
        self,
        retrieval_class,
        ranking_class,
        quality_service,
        ...
        retrieval_class.return_value.search.return_value = [
    ...
    def test_ranked_order_becomes_final_result_order(
        ...
        retrieval_class.return_value.search.return_value = [
            ...
            (
                ...
                "/notes/hydraulics.txt",

                1,

                "Aircraft hydraulic servicing procedures.",
            ...
            (
                ...
                "SQLite indexes reduce full table scans.",
    ...
    def test_empty_query_is_rejected(
        ...
        retrieval_class.return_value.search.assert_not_called()
    ...
    def test_candidate_pool_expands_before_ranking(
        self,
    ) -> None:
