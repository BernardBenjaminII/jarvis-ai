...
from knowledge_engine.catalog_enrichment.builder import CatalogEnrichmentBuilder
from knowledge_engine.storage.database import KnowledgeDatabase


def main() -> None:
    parser = argparse.ArgumentParser(description="Enrich Librarian catalog metadata")
    ...
    result = CatalogEnrichmentBuilder(db).build(
