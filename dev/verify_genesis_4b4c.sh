...
echo "========================================================================"
echo "JARVIS — GENESIS IV-B4C CANONICAL MIGRATION REGISTRY RECONSTRUCTION"
echo "========================================================================"
...
"$PYTHON_BIN" dev/verification/verify_genesis_iv_b4c.py
"$PYTHON_BIN" dev/verification/verify_genesis_iv_b4_audit_correction.py
