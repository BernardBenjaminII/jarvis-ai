# JARVIS Genesis IV-B1 RC1 — Executive Integration and Visibility Fabric
...
chmod +x genesis_iv_b1/dev/install_genesis_iv_b1_rc1.sh
./genesis_iv_b1/dev/install_genesis_iv_b1_rc1.sh
```
