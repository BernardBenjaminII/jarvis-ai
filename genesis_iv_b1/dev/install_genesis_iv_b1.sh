...
BACKUP_ROOT=".migration_backups/genesis_iv_b1_${TIMESTAMP}"
FILES=(
...
echo "========================================================================"
echo "JARVIS — INSTALL GENESIS IV-B1 INTEGRATION AND VISIBILITY FABRIC"
echo "========================================================================"
...
chmod +x dev/verify_genesis_4b1.sh
echo "[PASS] Backup root: $BACKUP_ROOT"
echo "[PASS] Genesis IV-B1 installation complete"
echo "Verify: PYTHON_BIN=\${PYTHON_BIN:-python3} ./dev/verify_genesis_4b1.sh"
