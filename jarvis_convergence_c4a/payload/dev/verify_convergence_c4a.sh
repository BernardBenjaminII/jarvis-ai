...
"$PYTHON_BIN" dev/verification/verify_convergence_c4a.py
...
"$PYTHON_BIN" -m unittest \
  ...
  tests.test_convergence_c4a_knowledge_compatibility

printf '[PASS] C-1 through C-4A deterministic tests\n'
