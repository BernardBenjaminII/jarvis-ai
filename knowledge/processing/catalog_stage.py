...
from knowledge.document import DocumentRecord
from knowledge.discovery.scanner import discover_files
from knowledge.metadata.fingerprints import sha256_file
